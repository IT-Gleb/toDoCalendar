...
const TaskTblTop = memo(function TaskTblTop({
  ...
  return (
    <div className="hidden sticky top-0 z-[2] sm:grid grid-cols-[25px_1fr_120px_120px] sm:mt-2 gap-x-2 uppercase text-[0.75rem] text-slate-100 font-bold text-center bg-gradient-to-b from-red-500 to-red-50">
